...
const Services = () => {
  ...
  const services = [
    {
      ...
      description:
        "Heavy and precision equipment for manufacturing, construction, processing, and more.",
      modal: "industrial",
    },
    {
      id: 2,
      ...
      description:
        "Our goal is to provide smart, future-ready solutions that support automation, efficiency, and data-driven operations.",
      modal: "technology",
    },
    {
      id: 3,
      ...
      description:
        "Whether for a university, hospital, or industrial lab, we ensure you receive equipment that supports accuracy and innovation.",
      modal: "laboratory",
    },
    {
      id: 4,
  ...
  const partners = [
    ...
    {
      id: 5,
      logo: "/Logoimags/Thermo_Fisher_Scientific_logo.png",
  ...
  return (
    <div className="services-page">
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              ...
              cost-effective machinery to meet a wide array of operational
              needs.
            </p>
            <ul>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              ...
              businesses to stay competitive and connected. Our technology
              solutions are tailored to support both industrial and commercial
              clients looking for dependable and scalable digital tools.
            </p>
            <ul>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              ...
              laboratory instruments and systems that meet international
              standards for research, testing, and analysis.
            </p>
            <ul>
              <li>
                Analytical instruments (spectrometers, chromatographs, etc.)
              </li>
      ...
      {activeModal === "smart-city" && (
        <div className="modal">
          <div className="modal-content">
            <span className="close-modal" onClick={closeModal}>
              &times;
            </span>
            <h3 className="modal-title">Smart City & Smart Poles</h3>
            <p>
              Serenta Trading delivers smart city infrastructure solutions
              including smart poles, urban lighting, connectivity, surveillance,
              and energy-efficient systems.
            </p>
            <ul>
              <li>
                Smart poles with integrated lighting, CCTV, and connectivity
              </li>
              <li>Public Wi-Fi and IoT sensor installations</li>
              <li>EV charging infrastructure and energy management</li>
              <li>Smart city planning and installation support</li>
            </ul>
            <Link to="/contact" className="btn">
              Contact Us
            </Link>
      ...
      {activeModal === "raw-materials" && (
        <div className="modal">
          <div className="modal-content">
            <span className="close-modal" onClick={closeModal}>
              &times;
            </span>
            <h3 className="modal-title">Raw Materials & Finished Products</h3>
            <p>
              We supply a wide range of raw materials and finished products
              tailored to industrial, manufacturing, and construction needs.
            </p>
            <ul>
              <li>High-quality raw materials for production</li>
              <li>Finished goods and components for assembly</li>
              <li>Bulk sourcing and logistics support</li>
      ...
      {activeModal === "electrical" && (
        <div className="modal">
          <div className="modal-content">
            ...
            <h3 className="modal-title">Electrical Equipment & Solar Energy</h3>
            <p>
              Our electrical solutions include solar energy systems, power
              distribution equipment, and industrial electrical components.
            </p>
            <ul>
              <li>Solar panels, inverters, and energy storage systems</li>
              <li>Electrical switchgear and distribution panels</li>
              <li>Industrial wiring, lighting, and control systems</li>
              <li>Renewable energy design and installation support</li>
            </ul>
            <Link to="/contact" className="btn">
              Contact Us
            </Link>
